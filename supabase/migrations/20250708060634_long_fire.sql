/*
  # Audio Session Looping Configuration

  1. New Columns
    - `seamless_loop` (boolean) - Enable seamless looping of audio sequences
    - `sequence_metadata` (jsonb) - Store loop configuration and metadata
    - `background_music_config` (jsonb) - Background music settings

  2. Updated Functions
    - Drop and recreate functions to avoid signature conflicts
    - Add looping parameters and configuration
    - Include helper functions for loop calculations

  3. Data Migration
    - Update existing sessions with default looping configuration
*/
...
-- Create the create_audio_session function with looping parameters
...
-- Create the get_user_audio_sessions function with looping info
