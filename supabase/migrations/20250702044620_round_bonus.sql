/*
  ...
  1. New Tables
    ...
    - `manifestations` - User's journal entries and their AI transformations
    - `challenges` - Available challenges (uses text ID for custom identifiers)
    - `challenge_progress` - User progress tracking for challenges
